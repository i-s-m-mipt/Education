...
#
# sudo apt install coreutils linux-tools-common linux-tools-$(uname -r) binutils util-linux procps
#
# sudo apt install pciutils iputils-ping traceroute iproute2 nmap curl lsof tcpdump telnet
#
...
g++ -S -std=c++23 -Wall -Wextra -Wpedantic -O0 -masm=intel ../source/02.17.cpp
