...
// content : Type Traits is_lvalue_reference and is_rvalue_reference
...
template < typename T > constexpr auto is_lvalue_reference_v = is_lvalue_reference < T > ::value;

template < typename T > constexpr auto is_rvalue_reference_v = is_rvalue_reference < T > ::value;
