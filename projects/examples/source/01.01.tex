...
\author{Developed by Associate Professor and Ph.D. \href{https://t.me/i_s_m_mipt}{\color{G} Ivan Makarov}}
...
\begin{frame}{\bf Introduction}
    ...
    \begin{itemize}
        ...
        \item Ph.D. in Artificial Intelligence and Machine Learning

        \item Associate Professor and Head of the Educational Laboratory

        \item Software Engineer and Researcher since 2010

        \item Main\:author\:of\:20\:articles in\:peer\,-\,reviewed\;scientific\;journals
    
        \item Main\:author\:of\:14\:reports\:at\:international\:conferences
        
    \end{itemize}

    \begin{block}
    \justifying In recent years, I have been developing various\;data\;processing\;sys-
    
    tems\;using\;parallel\;and\;network\;programming\;technologies,\;in\;parti-
    
    cular,\:infrastructure\:components\:for\:high-frequency\:trading\:systems.
    \end{block}
...
\begin{frame}{\bf C\texttt{++} Evolution}
    ...
    \begin{itemize}
        ...
        \item Influenced\;Python,\:Java,\:Go\;and\;many\;other\;languages
...
\begin{frame}{\bf C\texttt{++} Solutions}
    ...
    \begin{itemize}
        ...
        \item High\,-\,load servers for data processing
