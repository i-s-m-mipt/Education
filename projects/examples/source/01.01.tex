...
\begin{frame}{\bf Author of the Course}
...
\begin{frame}{\bf Developer Tools}

    \begin{tabular}{|l|l|l|}

        \hline

        \textbf{Tool} & \textbf{Considered} & \textbf{Alternative} \\
        ...
        \text{Git client} & SmartGit\texttt{,}\,IDE & GitHub Desktop \\

        \hline

        \text{Project\;hosting service} & GitHub & Bitbucket \\
