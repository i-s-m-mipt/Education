...
//  -----------------------------------------------------------------------------------------------
    ...
    auto lambda_1 = [](auto const & context) static { boost::spirit::x3::_val(context)  =     0; };

    auto lambda_2 = [](auto const & context) static { boost::spirit::x3::_val(context) += 1'000; };

    auto lambda_3 = [](auto const & context) static
    {
...
auto parse(std::string_view view)
{
    ...
    boost::spirit::x3::parse(std::begin(view), std::end(view), parser::rule, x);
