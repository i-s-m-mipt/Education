...
int main()
{
    ...
    std::cout << complex << std::endl; // output: (+0.000,+1.000)
...
//  ================================================================================================
    ...
    std::cout << (complex + complex) << std::endl; // output: (+0.000,+2.000)
    std::cout << (complex - complex) << std::endl; // output: (+0.000,+0.000)
    std::cout << (complex * complex) << std::endl; // output: (-1.000,+0.000)
    std::cout << (complex / complex) << std::endl; // output: (+1.000,+0.000)

//  ================================================================================================

    std::cout << std::conj (complex) << std::endl; // output: (+0.000,-1.000)
    std::cout << std::proj (complex) << std::endl; // output: (+0.000,+1.000)
    std::cout << std::exp  (complex) << std::endl; // output: (+0.540,+0.841)
    std::cout << std::log  (complex) << std::endl; // output: (+0.000,+1.571)
    std::cout << std::sqrt (complex) << std::endl; // output: (+0.707,+0.707)

//  ================================================================================================

    decltype(complex)::value_type r = 1.0, t = 0.8;

    std::cout << std::polar(r      ) << std::endl; // output: (+1.000,+0.000)
    std::cout << std::polar(r, t   ) << std::endl; // output: (+0.697,+0.717)
