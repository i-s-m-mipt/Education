...
\textbf{\large Fast Fourier Transformation Algorithm}

\bigskip

Let\begin{lalign}
    $Y_k = \sum_n X_n \cdot e^{-\frac{2\pi i}{N}nk}$
\end{lalign}
...
Hence,\begin{lalign}
    $Y_k = \sum_m X_{2m} \cdot e^{-\frac{2\pi i}{N}(2m)k} + \sum_m X_{2m+1} \cdot e^{-\frac{2\pi i}{N}(2m+1)k}$
\end{lalign}
...
Hence,\begin{lalign}
    $Y_k = {\sum_m X_{2m} \cdot e^{-\frac{2\pi i}{N/2} mk}} + e^{-\frac{2\pi i}{N}k} \cdot \sum_m X_{2m+1} \cdot e^{-\frac{2\pi i}{N/2} mk}$ for $m \in \{\,0,\,...,\,\frac{N}{2} - 1\,\}$ and $k \in \{\,0\,,\,\,...,\,\frac{N}{2} - 1\,\}$
\end{lalign}

\bigskip

Hence,\begin{lalign}
    $Y_k = \sum_m X_{2m} \cdot e^{-\frac{2\pi i}{N/2}mk} - e^{-\frac{2\pi i}{N}k} \cdot \sum_m X_{2m+1} \cdot e^{-\frac{2\pi i}{N/2} mk}$ for $m \in \{\,0,\,...,\,\frac{N}{2} - 1\,\}$ and $k \in \{\,\frac{N}{2},\,...,\,N - 1\,\}$
\end{lalign}
