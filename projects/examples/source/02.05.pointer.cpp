...
//	*ptr_null_1 = 42; // error: dereferencing nullptr

	if (ptr_null_1) // good: check pointer before dereferencing
	{
...
//	*ptr_cz1_1 = 42; // error: constant value
//	*ptr_cz1_2 = 42; // error: constant value

	[[maybe_unused]] const int * ptr_cz2_1 = &z2;
	[[maybe_unused]] auto        ptr_cz2_2 = &z2; // note: same as ptr_cz2_1

//	*ptr_cz2_1 = 42; // error: constant value
//	*ptr_cz2_2 = 42; // error: constant value
...
//	int * ptr_z2 = &z2; // error: pointer to non-constant
