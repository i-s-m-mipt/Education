...
Hence, $z = x \cdot y = x_2 \cdot y_2 \cdot 10^{2n} + (x_2 \cdot y_1 + x_1 \cdot y_2) \cdot 10^n + x1 \cdot y1$

\bigskip

$x_2 \cdot y_1 + x_1 \cdot y_2 = (x_2 + x_1) \cdot (y_2 + y_1) - x_1 \cdot y_1 - x_2 \cdot y_2$

\bigskip

Hence, $z = x \cdot y = x_2 \cdot y_2 \cdot 10^{2n} + ((x_2 + x_1) \cdot (y_2 + y_1) - x_1 \cdot y_1 - x_2 \cdot y_2) \cdot 10^n + x1 \cdot y1$

\bigskip

Hence, $z = x \cdot y = a \cdot 10^{2n} + (c - b - a) \cdot 10^n + b$, where $a = x_2 \cdot y_2$, $b = x_1 \cdot y_1$, $c = (x_2 + x_1) \cdot (y_2 + y_1)$
