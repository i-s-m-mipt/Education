...
int main()
{
    auto complex_1 = parse_complex("1.0"sv          );
    auto complex_2 = parse_complex("1.0+1.0i"sv     );
    auto complex_3 = parse_complex("1.0-1.0i"sv     );
    auto complex_4 = parse_complex(" 1.0 + 1.0 i "sv);
