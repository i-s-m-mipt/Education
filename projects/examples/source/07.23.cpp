...
// support : sudo cpupower frequency-set --governor performance --min 5.0GHz --max 5.0GHz
//
// support : sudo setarch $(uname --machine) --addr-no-randomize ./07.23
//
// support : sudo taskset --cpu-list 0 ./07.23
//
// support : sudo chrt --fifo 99 ./07.23
