...
{\large \textbf{10.02} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.17.cpp}{10.17}\,)}}

\bigskip

Доработайте примеры \href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.16.cpp}{\texttt{10.16}} и \href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.17.cpp}{\texttt{10.17}} таким образом, чтобы реализации использовали отслеживание минимальных элементов вместо максимальных. Реализуйте в классах \lstinline{Stack} публичные функции-члены \lstinline{min} для получения минимальных элементов. Доработайте в классах \lstinline{Stack} реализации функций-членов \lstinline{push},\,\lstinline{top}\,и\,\lstinline{pop}.

\bigskip

{\large \textbf{10.03} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.29.cpp}{10.29}\,)} \texttt{//} M. Bancila, The Modern C\texttt{++} Challenge}

\bigskip

Реализуйте алгоритм моделирования игры Жизнь по стандартным правилам на игровом поле размером 10 на 10 клеток. Установите вручную паттерн начального состояния игрового поля. Используйте стандартный двумерный контейнер \lstinline{std::vector} для хранения текущего состояния игрового поля. Используйте стандартный поток \lstinline{std::cout} для вывода через терминал состояний игрового поля на всех итерациях моделирования игры.

\bigskip

{\large \textbf{10.04} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.34.cpp}{10.34}\,)}}
...
{\large \textbf{11.04} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/11.12.cpp}{11.12}\,)}}
...
{\large \textbf{11.05} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/11.25.cpp}{11.25}\,)}}

\bigskip

Продемонстрируйте использование диапазонов и стандартных алгоритмов \lstinline{ranges::replace}, \lstinline{ranges::fill}, \lstinline{ranges::unique}, \lstinline{ranges::rotate} и \lstinline{ranges::sample} на простых примерах. Продемонстрируйте использование диапазонов и стандартных представлений \lstinline{views::filter}, \lstinline{views::drop}, \lstinline{views::join}, \lstinline{views::zip} и \lstinline{views::stride} на простых примерах. Реализуйте алгоритм \lstinline{transform_if} на основе комбинации стандартных алгоритмов \lstinline{ranges::transform} и \lstinline{ranges::copy_if}. Реализуйте алгоритмы вычисления средней абсолютной ошибки MAE и среднеквадратичной ошибки MSE на основе комбинации стандартных численных алгоритмов.

\bigskip

{\large \textbf{11.06} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/11.28.cpp}{11.28}\,)}}
