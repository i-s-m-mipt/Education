...
\newpage\thispagestyle{empty}\pdfpageheight = 7.80in\enlargethispage{100in}
...
Доработайте примеры \href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.15.cpp}{\texttt{10.15}} и \href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.16.cpp}{\texttt{10.16}} таким образом, чтобы реализации использовали отслеживание минимальных элементов вместо максимальных. Реализуйте в классах \lstinline{Stack} публичные функции-члены \lstinline{min} для получения минимальных элементов. Доработайте в классах \lstinline{Stack} реализации функций-членов \lstinline{push},\,\lstinline{top}\,и\,\lstinline{pop}.

\bigskip

{\large \textbf{10.03} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.30.cpp}{10.30}\,)} \texttt{//} M. Bancila, The Modern C\texttt{++} Challenge}
...
{\large \textbf{10.04} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.32.cpp}{10.32}\,)}}

\bigskip

Реализуйте алгоритм вычисления N\,-\,ого числа ряда Фибоначчи на основе метода матричной экспоненциации. Используйте библиотеку \href{https://www.boost.org/doc/libs/latest/libs/numeric/ublas/doc/}{Boost.UBLAS} для реализации матричных вычислений. Используйте тип \lstinline{usigned long long int} для значений элементов матриц. Реализуйте алгоритм быстрого возведения начальной матрицы в степень N. Обоснуйте алгоритмическую сложность реализованного алгоритма и сравните ее с алгоритмической сложностью всех других известных Вам алгоритмов вычисления N\,-\,ого числа ряда Фибоначчи.
...
Сравните среднее время вызова свободной функции, нестатической функции-члена класса, переопределенной виртуальной функции-члена класса, функционального объекта, лямбда\,-\,функции, сохраненной в переменной с местозаменителем типа \lstinline{auto} и лямбда\,-\,функции, сохраненной в стандартной оболочке \lstinline{std::function}. Реализуйте одинаковые условия вызова во всех случаях. Используйте нестандартный атрибут \lstinline{noinline} для предотвращения встраивания функций. Используйте\,библиотеку\,\href{https://github.com/google/benchmark}{Google.Benchmark}\,для\,реализации\,бенчмарков.

\bigskip

{\large \textbf{11.03} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/11.10.cpp}{11.10}\,)}}
...
{\large \textbf{11.04} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/11.13.cpp}{11.13}\,)}}
...
{\large \textbf{11.05} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/11.26.cpp}{11.26}\,)}}
...
{\large \textbf{11.06} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/11.29.cpp}{11.29}\,)}}
...
Доработайте примеры \href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/12.19.cpp}{\texttt{12.19}} и \href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/12.26.cpp}{12.26} таким образом, чтобы пользователь мог брать остаток от деления, возводить в степень и вычислять факториал чисел, а также использовать квадратные и фигурные скобки. Реализуйте грамматический разбор и вычисление выражений на основе бинарного оператора \lstinline{%} для взятия остатка от деления первого операнда на второй, бинарного оператора \lstinline{^} для возведения первого операнда в степень второго и унарного постфиксного оператора \lstinline{!} для вычисления факториала операнда. Не рассматривайте проблемы переполнения и точности типа \lstinline{double} при вычислении факториала чисел. Реализуйте грамматический разбор и вычисление выражений на основе квадратных и фигурных скобок в дополнение к круглым скобкам. Используйте оригинальную \href{https://github.com/Chrinkus/stroustrup-ppp/blob/master/chapter07/ch07_calculator.cpp}{реализацию} рекурсивного калькулятора Бьерна Страуструпа в качестве подсказки.
