...
\newpage\thispagestyle{empty}\pdfpageheight = 20.00in\enlargethispage{100in}
...
{\large \textbf{10.01} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.04.cpp}{10.04}\,)}}

\bigskip

Исследуйте систему автоматического увеличения емкости памяти стандартного контейнера \lstinline{std::vector}. Определите коэффициент умножения емкости памяти контейнера в случае нехватки свободных ячеек памяти. Реализуйте тесты для отслеживания изменений емкости памяти контейнера в процессе вставки новых элементов.

\bigskip

{\large \textbf{10.02} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.07.cpp}{10.07}\,)}}
...
{\large \textbf{10.03} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.17.cpp}{10.17}\,)}}
...
{\large \textbf{10.04} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.29.cpp}{10.29}\,)} \texttt{//} M. Bancila, The Modern C\texttt{++} Challenge}
...
{\large \textbf{10.05} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.30.cpp}{10.30}\,)}}

\bigskip

Доработайте пример \href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.30.cpp}{\texttt{10.30}} таким образом, чтобы реализация использовала алгоритм поиска непрерывной наибольшей общей подстроки вместо алгоритма поиска составной наибольшей общей подпоследовательности.

\bigskip

{\large \textbf{10.06} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/10.34.cpp}{10.34}\,)}}
