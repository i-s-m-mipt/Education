...
{\large \textbf{06.01} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/06.08.cpp}{06.08}\,)}}
...
{\large \textbf{06.04} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/education.sh}{06.17}\,)}}
...
{\large \textbf{06.05} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/06.18.cpp}{06.18}\,)}}
...
{\large \textbf{08.01} \texttt{(\,\href{https://github.com/i-s-m-mipt/Education/blob/master/projects/examples/source/08.10.cpp}{08.10}\,)} \texttt{//} H. Sutter, Exceptional C\texttt{++} Style}
